...
pub mod registries {
    pub use crate::world::block::registries::block_types;
    pub use crate::world::meshing::registries::{block_mesh_templates, block_textures};
    use crate::world::{block, meshing};
    
    pub fn init() {
        meshing::registries::init_block_textures();
        meshing::registries::init_block_mesh_templates();
        block::registries::init_block_types();
    }
}
